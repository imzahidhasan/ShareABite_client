  ...
  return (<>
    <div >
      ...
      <div className="relative bg-[#186F65] text-[#d8dcd2]">
        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <motion.div initial={{ opacity: 0, y: 50 }}
            ...
            <a
              className="flex items-center justify-center w-10 h-10 mx-auto text-white duration-300 transform  border-gray-400"
            >
              <motion.svg
                initial={{ x: 0 }}
                animate={{ y: 50 }}
      ...
      <div className='container mx-auto'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 m-5 container mx-auto">
          {
