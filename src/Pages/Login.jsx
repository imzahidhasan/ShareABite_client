            ...
            <Helmet title='ShareABite | Login'></Helmet>
            {
                user ? <Navigate to={'/'} />
                    : <div className='flex flex-col-reverse container mx-auto md:flex-row'>
                        <Lottie className='w-full md:w-1/2' animationData={login} />
                        <div className="mt-7 w-full md:w-1/2 mx-auto max-w-96 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
