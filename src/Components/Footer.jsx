...
const Footer = () => {
  return (
    <footer className="px-4 divide-y dark:text-gray-400 font-medium dark:bg-neutral-800">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          <Link to={'/'} className="flex justify-center space-x-3 lg:justify-start">
            ...
            <div>
              <span className="self-center text-2xl font-semibold">ShareABite</span>
              <p className='text-balance'>"Building a Zero-Waste Future, Bite by Bite"</p>
           </div>
          </Link>
        </div>
      ...
      <div className="py-6 text-sm text-center dark:text-gray-400">© 2024 ShareABite Co. All rights reserved.</div>
    </footer>
  )
}
